...
class GoingPostalTest < MiniTest::Unit::TestCase
  ...
  def test_it_format_postcode
    assert_equal("00118", GoingPostal.format_postcode("00118", "IT"))
    assert_equal("37121", GoingPostal.format_postcode("3 7\t1\r2\n 1", "IT"))
    assert_equal("12100", GoingPostal.format_postcode("I-\t12\r1\r0\n 0", "IT"))
    assert_equal("13100", GoingPostal.format_postcode("IT-13100", "IT"))

    assert_nil(GoingPostal.format_postcode("123", "IT"))
    assert_nil(GoingPostal.format_postcode("0123", "IT"))
    assert_nil(GoingPostal.format_postcode("1234", "IT"))
    assert_nil(GoingPostal.format_postcode("abcd", "IT"))
  end

  def test_it_postcode_query
    assert(GoingPostal.postcode?("00118", "IT"))
    assert(GoingPostal.postcode?("37121", "IT"))
    assert(GoingPostal.postcode?("I-12100", "IT"))
    assert(GoingPostal.postcode?("IT-13100", "IT"))

    refute(GoingPostal.postcode?("1230", "IT"))
    refute(GoingPostal.postcode?("AB-0123", "IT"))
    refute(GoingPostal.postcode?("145", "IT"))
  ...
  def test_es_format_postcode
    ...
    assert_equal("29011", GoingPostal.format_postcode("\t29\r0\r1\n 1", "ES"))
    assert_equal("30001", GoingPostal.format_postcode("30\t001", "ES"))

    assert_nil(GoingPostal.format_postcode("123", "ES"))
    assert_nil(GoingPostal.format_postcode("0123", "ES"))
    assert_nil(GoingPostal.format_postcode("1234", "ES"))
    assert_nil(GoingPostal.format_postcode("abcd", "ES"))
    assert_nil(GoingPostal.format_postcode("123456", "ES"))
  end

  def test_es_postcode_query
    assert(GoingPostal.postcode?("08001", "ES"))
    assert(GoingPostal.postcode?("08120", "ES"))
    assert(GoingPostal.postcode?("29011", "ES"))

    refute(GoingPostal.postcode?("1230", "ES"))
    refute(GoingPostal.postcode?("AB0123", "ES"))
    refute(GoingPostal.postcode?("145", "ES"))
  ...
  def test_pt_format_postcode
    ...
    assert_nil(GoingPostal.format_postcode("123", "PT"))
    assert_nil(GoingPostal.format_postcode("abcd", "PT"))
    assert_nil(GoingPostal.format_postcode("12345", "PT"))
    assert_nil(GoingPostal.format_postcode("12345-6", "PT"))
    assert_nil(GoingPostal.format_postcode("123456", "PT"))
  end

  def test_pt_postcode_query
    assert(GoingPostal.postcode?("3850-511", "PT"))
    assert(GoingPostal.postcode?("2775-015", "PT"))
    assert(GoingPostal.postcode?("4590-549", "PT"))

    refute(GoingPostal.postcode?("AB0123", "PT"))
    refute(GoingPostal.postcode?("145", "PT"))
    refute(GoingPostal.postcode?("abcd", "PT"))
    refute(GoingPostal.postcode?("1", "PT"))
  ...
  def test_pl_format_postcode
    ...
    assert_nil(GoingPostal.format_postcode("123", "PL"))
    assert_nil(GoingPostal.format_postcode("abcd", "PL"))
    assert_nil(GoingPostal.format_postcode("12345", "PL"))
    assert_nil(GoingPostal.format_postcode("1234-56", "PL"))
    assert_nil(GoingPostal.format_postcode("123456", "PL"))
  end

  def test_pl_postcode_query
    assert(GoingPostal.postcode?("00-001", "PL"))
    assert(GoingPostal.postcode?("40-868", "PL"))
    assert(GoingPostal.postcode?("65-540", "PL"))

    refute(GoingPostal.postcode?("AB0123", "PL"))
    refute(GoingPostal.postcode?("145", "PL"))
    refute(GoingPostal.postcode?("abcd", "PL"))
    refute(GoingPostal.postcode?("1", "PL"))
